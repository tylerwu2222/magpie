...
import CardLine from "../../modals/card_modals/card_content/CardLine/CardLine";
import AddLine from "../../modals/card_modals/card_content/AddLine/AddLine";
...
Partial<AnimatedCardContentProps>) {
  ...
  return (
    <>
      <MotiView style={styles.animatableCardContentView}>
        {topRightCardIcons ? (
          <View style={styles.topRightIconsView}>
