...
const CustomTextInput = ({
  ...
  const TextInputComponent = (
    <TextInput
      ...
      theme={{
        colors: {
          onSurfaceVariant: textInputColor.placeholder, // overrides placeholder color
          primary: textInputColor.placeholder, // overrides label color
        },
      }} 
      ...
      outlineStyle={{ borderRadius: 10, borderColor: "black", borderWidth: 1 }}
    />
  );
